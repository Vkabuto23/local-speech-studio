...
Включите **Разбить по спикерам**, выберите NeMo или pyannote и укажите ожидаемое число участников. Оба движка распознавания отдают таймкоды слов, которые использует общий этап назначения спикеров.
